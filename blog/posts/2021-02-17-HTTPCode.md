...
layout: Post
title: HTTP 状态码
subtitle: 常见的HTTP状态码及其含义
author: emo
date: 2021-02-17
useHeaderImage: true
headerImage: /img/in-post/HTTPCode.jpeg
...
当我们在浏览网页时，经常会遇见服务器返回不同的HTTP状态码，用于指示客户端请求的处理情况。了解这些状态码对于网站开发和网络故障排除都非常重要。
...
* 4xx(信息性状态码)：请求包含语法错误或无法完成
* 5xx(信息性状态码)：服务器在处理请求的过程中发生了错误
